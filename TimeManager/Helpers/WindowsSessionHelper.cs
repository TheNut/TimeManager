...
{
    /// <summary>Helper to identify when the windows desktop is 
    /// 
    /// </summary>
    public class WindowsSession : IDisposable
    {
        ...
        /// <summary>Open the desktop that receives user input. 
        ///     This method is used to check whether the desktop is locked. 
        ///     If the function fails, the return value is IntPtr.Zero.  
        ///     Note: 
        ///     If UAC popups a secure desktop, this method may also fail.
        ///     There is no API for differentiate between Locked Desktop and UAC popup. 
        /// </summary> 
        /// <param name="dwFlags"> 
        ...
        /// <summary>Close an open handle to a desktop object.</summary> 
        /// <param name="hDesktop">A handle to the desktop to be closed.</param> 
        /// <returns>If the function succeeds, then return true.</returns> 
        [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        ...
        /// <summary>Initialize the instance. Register the SystemEvents.SessionSwitch event.</summary> 
        ...
        /// <summary>Handle the SystemEvents.SessionSwitch event.</summary> 
        void SystemEvents_SessionSwitch(object sender, SessionSwitchEventArgs e)
        {
            this.OnStateChanged(e);
        }

        /// <summary>Raise the StateChanged event.</summary> 
        ...
        /// <summary>Check whether current session is locked.  
        ...
        /// <summary>Dispose the resources with boolean.</summary> 
        [PermissionSet(SecurityAction.LinkDemand, Name = "FullTrust")]
